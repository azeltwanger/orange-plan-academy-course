# Orange Plan Academy — Production Checklist

Work top to bottom, one module at a time. Per module: review scripts → film all 🎙 prompter items in one sitting → capture all 🖥 screen segments in a second sitting → edit → upload → paste text. Check boxes as you go.
...
>
> Slop gates, all at zero across scripts + lesson text: announcing-importance,
...
☐ 1.1 How to use this course — 🎙 film (~11 min)
☐ 1.2 How the AI works: what it reads, what it never sees — 🎙 film (~6 min)
...
☐ 2.1 What to gather before you build the plan — 🎙 film (~6 min)
☐ 2.2 Set your growth and inflation assumptions — 🎙 film (~8 min)
☐ 2.3 Read your retirement date and confidence number — 🎙 film (~7 min)
☐ 2.4 Walkthrough: set up your plan in Orange Plan — 🖥 capture
☐ 2.5 Walkthrough: build your baseline in Orange Plan — 🖥 capture
...
## ☐ MODULE 3 — DEBT STRATEGY   ·   WAVE 1

☐ 4.1 Give every debt a job and set your ceiling — 🎙 film (~9 min)
☐ 4.2 Walkthrough: give every debt a job in Orange Plan — 🖥 capture
☐ Paste the Module 3 checkpoint into Circle (top: "By the end…", bottom: "Complete when…")

## ☐ MODULE 4 — ALLOCATION & NEXT-DOLLAR   ·   WAVE 1

☐ 5.1 Set the Bitcoin allocation you can hold through a full drawdown — 🎙 film (~9 min)
☐ 5.2 Break your accounts down by holding type, then by timeframe — 🎙 film (~9 min)
☐ 5.3 Order your contributions: which account gets funded first — 🎙 film (~9 min)
☐ 5.4 Asset location: which account each holding belongs in — 🎙 film (~6 min)
☐ 5.5 Walkthrough: route it in Orange Plan — 🖥 capture
☐ Paste the Module 4 checkpoint into Circle (top: "By the end…", bottom: "Complete when…")

## ☐ MODULE 5 — TAX STRATEGY   ·   WAVE 2

☐ 6.1 Cost basis: what you paid, and how to reconstruct it — 🎙 film (~5 min)
☐ 6.2 Taxable, tax-deferred, and Roth: bracket windows and state taxes — 🎙 film (~8 min)
☐ 6.5 Walkthrough: model it in Orange Plan — 🖥 capture
☐ Paste the Module 5 checkpoint into Circle (top: "By the end…", bottom: "Complete when…")

## ☐ MODULE 6 — RETIREMENT INCOME   ·   WAVE 2

☐ 7.1 Your spending, income floor, gap, and bridge years — 🎙 film (~9 min)
☐ 7.3 Set your withdrawal order and refill rule — 🎙 film (~9 min)
☐ 7.5 Guardrails: how much you can spend each year — 🎙 film (~8 min)
☐ 7.6 Walkthrough: build the paycheck in Orange Plan — 🖥 capture
...
☐ 8.5 Walkthrough: document your custody map in Orange Plan — 🖥 capture
...
☐ 9.5 Walkthrough: Protect, the heir letter, and the switch — 🖥 capture
...
☐ 6. 9.5 Advanced: do you need a trust, and which one? — 🎙 film (~12 min)
☐ 7. 7.2 Health insurance between retiring and Medicare — 🎙 film (~6 min)
...
☐ — A7.2 What self-custody actually asks of you — TEXT ONLY for now
