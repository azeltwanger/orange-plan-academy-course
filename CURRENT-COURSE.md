...
- revised visuals that depend on accepted app outputs,
- and Austin's final voice/judgment pass.

No additional course-wide structural or demo-input decision pass is planned before Austin reads the scripts.

## Source-of-truth order

1. `CURRENT-COURSE.md` — current curriculum and production stage
2. `DEMO-HOUSEHOLD.md` — approved continuous-demo inputs and change control
3. `AUSTIN-DEMO-DECISIONS.md` — approval record for the fictional planning judgments
4. `PRE-DICTATION-QA.md` — remaining gates and ownership
5. `DEMO-CHECKPOINT-RUN-SHEET.md` — app-entry and output-capture process
6. `scripts/` — current spoken drafts
7. `lesson-text/` — current student reference text
8. `COURSE-APP-CONTRACT.md` — pedagogy, app-state, and number-provenance rules
9. `BUILD-YOUR-PLAN-CROSSWALK.md` — future walkthrough routing
10. `professional-review/` — canonical external-review packets
11. `research/SLIDE-CORRECTION-MAP.md` — treatment of the current decks
12. `research/CLIENT-CALL-VOICE-EVIDENCE.md` and `research/CLIENT-CONFUSION-REGISTRY.md`
...
The approved household uses:

- Alex, 45; Jordan, 43; two children, 10 and 12; Colorado; married filing jointly
- Built-in Power Law Bitcoin view
- Current standard app defaults for other broad asset classes
- 3% baseline inflation and a separate 4% inflation stress Scenario
- Age 55 retirement target, $100,000 retirement living spending in today's dollars, age 95 planning horizon, and an 80% Plan confidence target
- $20,000 of part-time income for the first 3 retirement years
- Alex Social Security of $30,000 at age 67 and Jordan Social Security of $22,000 when Jordan reaches 67 two years later
- 50% Bitcoin target with a 40–60% review band
- Household ceiling of 25% DTI and no added debt at DTA of 40% or higher
- $625/month to the family HSA, $625/month to the Roth IRA, and the HSA assigned to the qualified Healthcare Bridge
- Optional $80,000 total-family college commitment
- No Bitcoin-backed loan in the saved Core baseline

The starting retirement-paycheck choice remains an app-output decision. It is made after the Income checkpoint measures the current $100,000 Plan amount beside the calculated reference choices.
...
- Broad returns, 3% baseline inflation, 4% inflation stress Scenario, and planning horizon
...
- Apply the approved fictional household ceiling
...
- Separate current mix, 50% target, 40–60% review band, and today's action
- Reserve, Bridge, qualified Healthcare Bridge, and Legacy
- Account wrapper versus holdings
- Strong presumptions followed by a comparison zone and deliberate split
- Route the approved $625 HSA and $625 Roth contributions without exceeding the $4,000 surplus
...
- Part-time income and staggered Social Security as a year-by-year timeline
...
| Module | Structure | Demo inputs | App outputs | External review | Austin review |
|---|---|---|---|---|---|
| 0 · Start Here | PASS | N/A | N/A | N/A | NOT STARTED |
| 1 · Baseline | PASS | APPROVED | CHECKPOINT HOLD | N/A | NOT STARTED |
| 2 · Cash Flow | PASS | APPROVED | CHECKPOINT HOLD where app-calculated | N/A | NOT STARTED |
| 3 · Debt | PASS | APPROVED | CHECKPOINT HOLD | N/A | NOT STARTED |
| 4 · Allocation | PASS | APPROVED | CHECKPOINT HOLD | CPA only for tax-location qualifications | NOT STARTED |
| 5 · Tax | PASS | APPROVED | CHECKPOINT HOLD | CPA RESPONSE HOLD | NOT STARTED |
| 6 · Retirement Income | PASS | APPROVED except starting paycheck | CHECKPOINT HOLD | CPA RESPONSE HOLD for tax mechanics | NOT STARTED |
| 7 · Custody | PASS | APPROVED STARTING STATE | REAL-WORLD TEST HOLD | CUSTODY RESPONSE HOLD | NOT STARTED |
| 8 · Estate / Insurance | PASS | APPROVED STARTING STATE | REAL-WORLD / POLICY HOLD | ATTORNEY + INSURANCE RESPONSES HOLD | NOT STARTED |
| 9 · Maintain / Test / Read | PASS | APPROVED | CHECKPOINT HOLD | N/A | NOT STARTED |

## Next work before Austin reads once

1. Enter `demo-v1-inputs` in the accepted app build.
2. Capture the eight checkpoint receipts and choose the starting retirement paycheck from the real Income result.
3. Apply the external professional responses.
4. Verify the deployed Build Your Plan flow before recording exact clicks.
5. Give Austin the final scripts for one voice-and-judgment read.
