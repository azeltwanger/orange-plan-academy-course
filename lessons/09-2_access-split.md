<artifact
  data-placement-id="outcomes-6a64f0ab7a4e065314421d3f"
  data-artifact-id="6a6754643a9be21a8d113311"
  data-params='{"items":["Design an access split appropriate to your custody setup","Understand how a passphrase carries the split for single-sig wallets","Understand how multisig achieves the split with keys and a config file","Test your split with a small amount before it matters"]}'
></artifact>
