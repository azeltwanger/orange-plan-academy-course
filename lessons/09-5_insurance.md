<artifact
  data-placement-id="outcomes-6a64f0ad6a9cf5f18da44cad"
  data-artifact-id="6a6754643a9be21a8d113311"
  data-params='{"items":["Understand insurance as protection you rent until the stack can carry the weight","Calculate the term-life gap using annual hole × years to cover minus stack","Identify the four coverage lines that still matter","Run the graduation review each year"]}'
></artifact>

# Insurance: the risks you can't self-insure yet
