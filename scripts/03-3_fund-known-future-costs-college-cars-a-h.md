...
Then route the monthly amount at Cash Flow → Routing. For a fixed cost that's your target divided by the months you've got. For college it's whatever closes the gap between the 529's projected value and the part of your commitment you've decided to protect, which is usually a much smaller number than people expect.
...
For college specifically, you're done when you can say what you're committing to provide, name the sources that will cover it, and point at the part you've decided to protect from a Bitcoin sale. **You are not done when the whole sticker price is sitting in cash.** That was never the target.
