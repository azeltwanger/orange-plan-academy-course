# WALKTHROUGH 2.4 — onboarding + baseline (screen share)

**Two sessions: A = onboarding (13 steps) · B = baseline lap (9 steps)**
...
- "that's your baseline — everything else builds on it" → END
