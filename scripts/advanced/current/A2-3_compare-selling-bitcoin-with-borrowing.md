...
Selling and borrowing solve the same immediate problem in different ways: they create cash.

The useful question is: **which cost and risk is the household choosing in exchange for that cash?**
...
At $100,000 Bitcoin, selling 0.30 BTC produces $30,000 before transaction costs and tax.

Suppose the units sold have $10,000 of basis.

The realized gain is $20,000 before the CPA applies holding period, other income and gains, filing status, state, identification rules, and current law.

After the sale:

- there is no loan balance,
- no lender holds collateral,
- no interest accrues,
- and 0.30 BTC no longer participates in future gains or losses.

The cost is visible and final.

== THE BORROW SIDE ==

Borrowing $30,000 against 1.50 BTC at a $100,000 price starts at 20% LTV.

After borrowing:

- the household still has price exposure to the 1.50 BTC,
- it owes $30,000 plus interest and fees,
- the collateral is pledged,
- and a major decline can trigger action or liquidation under the agreement.
...
**What it means:** units removed by the sale versus units still exposed under the loan path.

**Calculated from:** cash need, selected lots, modeled price, and funding strategy.
...
Choose sell, borrow, or another funding source based on the full trade-off—not on tax alone and not on Bitcoin upside alone.
