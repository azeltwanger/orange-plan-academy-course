...
[W01, chapter 8](working/W01_build-the-first-working-plan.md): read early/later assumptions, run one controlled comparison and return to the current plan. Use [custom assumptions](../reference/custom-assumptions.md) when a holding needs additional treatment.
