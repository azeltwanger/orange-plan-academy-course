...
Bottom: one horizontal guardrail line:
    ...
    Lower guardrail        Current retirement portfolio        Upper guardrail
    $1.45M --------------------------●---------------------------- $2.40M
                                  $1.82M
...
## Labels and data
The dollar values are illustrative. Show a separate note: **Annual spending change capped at 10%**. The core customer visual contains portfolio levels and review status. Internal probability boundaries stay in Advanced methodology.
