...
- **A1.1 How Orange Plan models Bitcoin: fat tails, correlations, floors and caps**
  → *Watch this if you want to defend your confidence number rather than take it on faith, or if you are about to hand your report to someone who will ask how the simulation works. Core 1.3 teaches how to *read* the number; this is how it is *built*.*
