...
- All 64 surviving non-Reserve teaching scripts received individually authored paragraph edits: 152 selected replacements/deletions, with 17 producer/evidence passages retained outside spoken text. Existing reasoning, numbers and useful qualifications remain. This is a copyedit, not a claim every script was rewritten from scratch or approved.
