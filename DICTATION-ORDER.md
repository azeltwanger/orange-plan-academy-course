...
**28 teach lessons · 218 min (3.6 h) of finished audio at 155 wpm.**
...
long a Bitcoin recovery takes. Your 2.2 dictation is the canonical wording.
...
including your 0.1. If you'd rather say a range, say it here and it gets
...
| 0.2 | How to use Orange Plan AI | 7.0 |
...
| 1.2 | The three layers of a plan, and setting your assumptions | 10.2 |
...
| # | Lesson | min |
|---|---|---|
| 3.1 | Give every debt a job and set your ceiling | 8.7 |
| 3.2 | *Walkthrough: give every debt a job in Orange Plan* | — WALKTHROUGH, narrated off the sheet |
...
| # | Lesson | min |
|---|---|---|
| 5.1 | Cost basis: what you paid, and how to reconstruct it | 6.3 |
| 5.2 | Taxable, tax-deferred, and Roth: bracket windows and state taxes | 6.0 |
...
| # | Lesson | min |
|---|---|---|
| 6.1 | Your spending, income floor, gap, and bridge years | 9.0 |
| 6.2 | Set your withdrawal order and refill rule | 8.9 |
...
| 7.2 | Set up a hardware wallet and test recovery | 5.3 |
| 7.3 | Single points of failure, account hardening, and scams | 3.9 |
...
| 8.2 | Split access: dual control and redundancy | 5.1 |
...
| 9.2 | Test a decision and read the finished plan | 10.9 |
