...
**Your honest score, and what job each pile of Bitcoin is doing.**

1. **Answer all 5 out loud, about today**, not how you intend things to be. A miss is an item on a list, not a failure.
2. **Look at each pile separately.** A 20-year stack and an emergency-reachable stack are doing different jobs and don't need the same setup.
3. **Most people score 1 or 2 the first time.** That's normal, and it turns a vague worry into 3 specific jobs.
