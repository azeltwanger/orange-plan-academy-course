...
2. **Read the three timeframes**: Strategy → Allocation → Funding your timeframes: Reserve / Bridge / Legacy with Funded / Behind badges. Reserve Behind gets fixed first.
...
**Done when:** all accounts sorted, three Funded badges (or a named next action), mix at 100%, full match captured, and the plan survives Bear Market with an honest yes.
