...
Retirement contributions are *not* subtracted — they're decisions, not expenses. Surplus is money not yet committed; where it goes is the next module's question.

## The one input people get wrong

Your spending number is your after-tax **living** expenses. Enter your paycheck instead and the plan sizes retirement for spending that doesn't exist — every projection downstream is wrong.
...
- **Reduce** — keep it, pay less (insurance, phone, internet — one call, saved forever)
...
2. Label every line Keep / Cut / Reduce. Kill one subscription, renegotiate one bill.
