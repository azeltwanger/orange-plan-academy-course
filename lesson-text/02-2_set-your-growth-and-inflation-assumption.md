...
1. **Start with what you'd defend out loud.** If you can't explain why you picked a curve, you didn't really pick it. You left whatever the app had loaded.
2. **Ask which way you'd rather be wrong.** Conservative and wrong means you retire earlier than the screen said. Optimistic and wrong means the plan was built on something that didn't happen.
3. **Set inflation to what you actually believe**, because your future spending rises with it.

## Homework

1. Pick your Bitcoin growth model and say why.
2. Set your inflation number.
3. Enter both under **Plan → Edit assumptions**.
