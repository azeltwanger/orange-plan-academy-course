...
**Rules:** stay conservative when Bitcoin is high, use room when it's low, anchor to the full cycle rather than today's print, and use DTI as your floor — it doesn't move with price.
