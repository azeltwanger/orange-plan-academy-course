# Give every debt a payoff decision
...
1. Line up every debt with its rate.
2. Assign tier + job + written reason for each.
3. Every debt ends with a decision, not a feeling.
